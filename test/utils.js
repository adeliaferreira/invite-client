...
exports.mockedClientToInviteDefaultParameters = [
    ...
    { user_id: 28, name: 'Charlie Halligan' },
...
exports.mockedClientToInvite45KM = [
    { user_id: 4, name: 'Ian Kehoe' },
    { user_id: 5, name: 'Nora Dempsey' },
    { user_id: 6, name: 'Theresa Enright' },
    { user_id: 11, name: 'Richard Finnegan' },
...
exports.mockedClientToInvite200KM = [
    { user_id: 3, name: 'Jack Enright' },
    { user_id: 4, name: 'Ian Kehoe' },
    { user_id: 5, name: 'Nora Dempsey' },
    { user_id: 6, name: 'Theresa Enright' },
    { user_id: 7, name: 'Frank Kehoe' },
    { user_id: 8, name: 'Eoin Ahearn' },
    { user_id: 9, name: 'Jack Dempsey' },
    { user_id: 10, name: 'Georgina Gallagher' },
    { user_id: 11, name: 'Richard Finnegan' },
    { user_id: 12, name: 'Christina McArdle' },
    { user_id: 13, name: 'Olive Ahearn' },
    { user_id: 15, name: 'Michael Ahearn' },
    { user_id: 16, name: 'Ian Larkin' },
    { user_id: 17, name: 'Patricia Cahill' },
    { user_id: 18, name: 'Bob Larkin' },
    { user_id: 20, name: 'Enid Enright' },
    { user_id: 22, name: 'Charlie McArdle' },
    { user_id: 23, name: 'Eoin Gallagher' },
    { user_id: 24, name: 'Rose Enright' },
    { user_id: 25, name: 'David Behan' },
    { user_id: 26, name: 'Stephen McArdle' },
    { user_id: 27, name: 'Enid Gallagher' },
    { user_id: 28, name: 'Charlie Halligan' },
    { user_id: 29, name: 'Oliver Ahearn' },
    { user_id: 30, name: 'Nick Enright' },
    { user_id: 31, name: 'Alan Behan' },
...
exports.mockedClientToDifferentCoordinatesDefault = [
    { user_id: 8, name: 'Eoin Ahearn' },
    { user_id: 17, name: 'Patricia Cahill' },
    { user_id: 23, name: 'Eoin Gallagher' },
    { user_id: 24, name: 'Rose Enright' }
...
exports.mockedClientToDifferentCoordinates185KMRange = [
    { user_id: 4, name: 'Ian Kehoe' },
    { user_id: 5, name: 'Nora Dempsey' },
    { user_id: 6, name: 'Theresa Enright' },
    { user_id: 8, name: 'Eoin Ahearn' },
